...
import { CAVOS_CORE_API, SECRET_TOKEN, wallet_provider_api, WALLET_PROVIDER_TOKEN } from "./constants";
...
export const getUsdcPrice = async () => {
    try {
        const url = `https://api.devnet.pragma.build/node/v1/data/usdc/usd`;
